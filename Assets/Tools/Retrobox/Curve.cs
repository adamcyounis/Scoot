    ...
    public class Curve {
        ...
        public void DrawCurve(Rect startBounds, Rect endBounds, bool drawHandles = true, bool drawAnchors = true) {
            ...
            if (drawHandles) {
                ...
                Handles.DrawWireCube(sa1, Vector3.one * controlDims);
                Handles.DrawWireCube(sb1, Vector3.one * controlDims);
            }

            //draw the control points
            if (drawAnchors) {
                Handles.DrawWireCube(sa, Vector3.one * controlDims);
                Handles.DrawWireCube(sb, Vector3.one * controlDims);
            }
